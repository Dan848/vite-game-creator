    ...
    <div v-if="store.characters">
            ...
            <div class="row mt-5">
                ...
                <ul class="pagination d-flex justify-content-end">
                    <li class="page-item"><button :class="{ 'page-link': true, 'disabled': store.currentPage === 1 }"
                            @click="getCharacter(store.currentPage - 1)"><i class="fa-solid fa-angle-left"></i></button>
                    </li>
                    ...
                    <li class="page-item"><button
                            ...
                            @click="getCharacter(store.currentPage + 1)"><i class="fa-solid fa-angle-right"></i></button>
                    </li>
                </ul>
                <div v-for="character in store.characters"
                    class="mb-5 d-flex justify-content-center align-items-center flex-column col-12 col-md-6 col-lg-4 g-5">
        ...
        <div v-else class="container">
            ...
            <div class="row justify-content-between mt-5">
                <div v-for="(character, index) in store.playGame"
                    class="mb-5 d-flex justify-content-center align-items-center flex-column col-12 col-md-6 col-lg-4 g-5">
                    <CharacterCard :key="index" :character="character" :imgStartUrl="store.imgStartUrl" />
                    <div>
                        <select v-if="character.items.length !== 0" @change="getWeapon()" class="w-100 form-select"
                            name="items" v-model="store.selectedWeapon[index]">
                            <option value="">Nessun arma</option>
